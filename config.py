...
class Config:
    ...
    FONT_EXTS: Set[str] = field(default_factory=lambda: {
        ".ttf", ".otf", ".woff", ".woff2",
    })

    DATABASE_EXTS: Set[str] = field(default_factory=lambda: {
        ".db", ".sqlite", ".sqlite3", ".mdb",
    })

    EXECUTABLE_EXTS: Set[str] = field(default_factory=lambda: {
        ".exe", ".bin", ".run",
    })

    SYSTEM_EXTS: Set[str] = field(default_factory=lambda: {
        ".dll", ".sys", ".drv",
    })
    ...
    DISK_IMAGE_EXTS: Set[str] = field(default_factory=lambda: {
        ".iso", ".img", ".vhd", ".vmdk",
    })

    COMPRESSED_ASSET_EXTS: Set[str] = field(default_factory=lambda: {
        ".pak", ".assets", ".ress",
    })
